...
(function($) {
  ...
  top: 0;">
    ...
    <ul  >
      ...
      <li ><a href='https://secureito.com/welcome.php'>Enquiry List</a></li>
      <li><a href='#'>Notice Board</a>
        <ul>
          <li><a href='https://secureito.com/addnotice.php'>Add Notice</a></li>

          <li><a href='https://secureito.com/noticeboard.php'>View Notice board</a></li>
        ...
        <ul>
          <li><a href='https://secureito.com/addtestimony.php'>Add testimony</a></li>

          <li><a href='https://secureito.com/viewtestimony.php'>View testimony</a></li>
        </ul>
          <li><a href='#'>Gallery</a>
        <ul>
                    <li><a href='https://secureito.com/galleryupload.php'>Create new Title</a></li>

          <li><a href='https://secureito.com/addimages.php'>Add images into existing title</a></li>

          <li><a href='https://secureito.com/viewgallerytitle.php'>View existing Titles</a></li>
...
<div class="form-box form" style="margin-top: 50px;margin-left: 10vw;background-color: #f2f2f2;">
  ...
  <form action="addednotice.php" method="POST">
    <div class="form-group">
      ...
      <label for="link" style="font-size: 20px; font-weight: normal;margin-bottom: 10px;text-align: left!important" >link</label>
      <input class="form-control" id="link" type="link" name="link" placeholder="Enter Link" >
    </div>
